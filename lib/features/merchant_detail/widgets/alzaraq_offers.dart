...
class AlzaraqOffer extends ConsumerStatefulWidget {
  const AlzaraqOffer({super.key, required this.merchantModel});
  final MerchantModel merchantModel;

  @override
  ConsumerState<AlzaraqOffer> createState() => _AmmanOffersState();
}

class _AmmanOffersState extends ConsumerState<AlzaraqOffer> {
    ...
    return ExpansionTile(
      ...
      children: [
        Consumer(builder: (context, ref, child) {
          final offerStream =
              ref.watch(watchAlzraqOfferProvider(widget.merchantModel));
